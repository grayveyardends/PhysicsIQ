"""physicsiq — the Python package behind the PhysicsIQ workbench.
...
# __file__ = .../PhysicsIQ/physicsiq/__init__.py
...
PACKAGE_DIR = os.path.dirname(os.path.realpath(__file__))   # .../PhysicsIQ/physicsiq
ADDON_DIR = os.path.dirname(PACKAGE_DIR)                    # .../PhysicsIQ
REPO_DIR = os.path.dirname(ADDON_DIR)                       # repo root


def icon_path() -> str:
    return os.path.join(ADDON_DIR, "icons", "physicsiq.svg")
